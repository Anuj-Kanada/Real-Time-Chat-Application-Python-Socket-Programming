...
if __name__ == '__main__':  # it will only call the main function when run the server.py directly if i will import module it dont call main functiton
    main()